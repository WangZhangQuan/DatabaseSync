...
import com.wzq.target.mysql.MySqlDialect;
...
public class MemSqlTest {
    ...
    private static final String MEM_URL = "jdbc:mysql://192.168.56.128:3307/test";
...
//            ps.execute();
        ...
        // mysql 批量插入 驱动6 耗时58105，驱动8 耗时58479
        // mysql 单次插入 驱动6 耗时60949，驱动8 耗时59985
    ...
    public void t5() throws SQLException, ClassNotFoundException {
        ...
        while (columns.next()) {
            ...
            for (int i = 1; i <= columnCount; i++) {
                ...
                System.out.println(mySqlDialect.getSqlTypeString(columns.getInt("DATA_TYPE")));
...
//        Structure structure = new MySqlTarget(new TargetManagerImpl(), connection, new MySqlTargetParameter("", "", "", "")).getStructure(new String[]{"person"}, null);
